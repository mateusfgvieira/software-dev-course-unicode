...
let inputText = readline.question('Please input your string: ');
let sumCodePoints = inputText.charCodeAt(0) + inputText.charCodeAt(1);
console.log(`The sum of the first two code points in '${inputText}' is ${sumCodePoints}`);
...
let codePoint1 = readline.questionInt('Please input your first code point: ');
let codePoint2 = readline.questionInt('Please input your second code point: ');
let combinedString = String.fromCharCode(codePoint1) + String.fromCharCode(codePoint2);
console.log(`Your combined string is ${combinedString}`);
...
Expected Output:
codePointDifference: 49 // 'C' = 67, 't' = 116, |67 - 116| = 49
*/

let inputText2 = readline.question('Please input a string of at least two characters: ');
let index1 = readline.questionInt('Please input value for index 1: ');
let index2 = readline.questionInt('Please input value for index 2: ');
let codePointDifference = Math.abs(inputText2.charCodeAt(index1) - inputText2.charCodeAt(index2));

console.log(`The absolute value of ${inputText2}[${index1}] - ${inputText2}[${index2}] is ${codePointDifference}`);
